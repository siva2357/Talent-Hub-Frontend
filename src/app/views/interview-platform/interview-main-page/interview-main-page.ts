...
@Component({
  selector: 'app-interview-main-page',
  imports: [RouterOutlet],
  templateUrl: './interview-main-page.html',
  styleUrl: './interview-main-page.css',
  standalone:true
})
export class InterviewMainPage {
 ...
 logout() {
    this.router.navigate(['/interview-platform/login']);  // Redirect to login page
  }
